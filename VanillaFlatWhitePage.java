...
public class VanillaFlatWhitePage {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[6];
	private static String OrderName = "Vanilla Flat White";
	...
	public static void showWindow() {
		...
		JFrame frame =  new JFrame("Vanilla Flat White");
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("Vanilla Flat White");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setBounds(176, 6, 177, 32);
		frame.getContentPane().add(lblNewLabel);
		
//-----------------------------------------------------------------------------------------------------------
		//setBounds(x-coordinate, y-coordinate, length, height)
		
		JLabel lblSize = new JLabel("Size: SMALL ONLY");
		lblSize.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		lblSize.setBounds(5, 53, 125, 15);
		...
		rdbtnNicaragua.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(rdbtnNicaragua.isSelected()) {
					...
					textField.setText(OrderNameArray[0] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5]);
				}
			}
		});		
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblType = new JLabel("Type: HOT ONLY");
		lblType.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		lblType.setBounds(5, 118, 125, 15);
...
//				EspressoPage espresso = new EspressoPage();
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Order order = new Order(OrderNameArray[0] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5], price);
				OptionPage.AddToCart(order);
				
				JOptionPane.showMessageDialog(null, OrderNameArray[0] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5] + " is added to the Cart!" );
				frame.setVisible(false);
