...
public class WhiteChocolateMochaPage {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[6];
	private static String OrderName = "White Chocolate Mocha";
	...
	public static void showWindow() {
		...
		JFrame frame =  new JFrame("White Chocolate Mocha");
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("White Chocolate Mocha");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setBounds(137, 6, 235, 32);
		...
		rdbtnSmall.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(rdbtnSmall.isSelected()) {
					...
					textField.setText(OrderNameArray[0] + " " + OrderNameArray[1] + " " + OrderNameArray[2] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5]);
...
//-----------------------------------------------------------------------------------------------------------
		...
		lblType.setBounds(5, 118, 35, 15);
		frame.getContentPane().add(lblType);
				
		JRadioButton rdbtnIced = new JRadioButton("Iced");
		rdbtnIced.setBounds(35, 116, 65, 20);
		frame.getContentPane().add(rdbtnIced);
				
		JRadioButton rdbtnHot = new JRadioButton("Hot");
		rdbtnHot.setBounds(105, 116, 65, 20);
		frame.getContentPane().add(rdbtnHot);
		
		rdbtnIced.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				
				if(rdbtnIced.isSelected()) {
					rdbtnHot.setSelected(false);
					OrderNameArray[2] = "Iced";
					textField.setText(OrderNameArray[0] + " " + OrderNameArray[1] + " " + OrderNameArray[2] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5]);
				}
			}
		});
		...
		rdbtnHot.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(rdbtnHot.isSelected()) {
					rdbtnIced.setSelected(false);
					OrderNameArray[2] = "Hot";
					textField.setText(OrderNameArray[0] + " " + OrderNameArray[1] + " " + OrderNameArray[2] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5]);
				}
			}
		});
...
//				EspressoPage espresso = new EspressoPage();
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Order order = new Order(OrderNameArray[0] + " " + OrderNameArray[1] + " " + OrderNameArray[2] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5], price);
				OptionPage.AddToCart(order);
				
				JOptionPane.showMessageDialog(null, OrderNameArray[0] + " " + OrderNameArray[1] + " " + OrderNameArray[2] + " " + OrderName + " " + OrderNameArray[4] + " " + OrderNameArray[5] + " is added to the Cart!" );
				frame.setVisible(false);
