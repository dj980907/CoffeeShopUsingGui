...
public class CaramelMacchiatoPage {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[6];
	private static String OrderName = "Caramel Macchiato";
	...
	public static void showWindow() {
		...
		JFrame frame =  new JFrame("Caramel Macchiato");
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("Caramel Macchiato");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setBounds(168, 6, 185, 32);
