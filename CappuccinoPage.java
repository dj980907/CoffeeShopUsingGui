...
public class CappuccinoPage {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[6];
	private static String OrderName = "Cappuccino";
	...
	public static void showWindow() {
		...
		JFrame frame =  new JFrame("Cappuccino");
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("Cappuccino");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setBounds(195, 6, 122, 32);
