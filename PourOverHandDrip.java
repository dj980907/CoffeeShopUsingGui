...
public class PourOverHandDrip {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[6];
	private static String OrderName = "Pour Over Hand Drip Coffee";
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("Pour Over Hand Drip");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setBounds(156, 6, 199, 32);
