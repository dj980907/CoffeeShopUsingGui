...
public class StrawberryCakePage {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[3];
	private static String OrderName = "Strawberry Cake";
	...
	public static void showWindow() {
		...
		JFrame frame =  new JFrame("Strawberry Cake");
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("Strawberry Cake");
