...
public class ChemexPage {
	private static JTextField textField;
	private static String [] OrderNameArray = new String[6];
	private static String OrderName = "Chemex";
	...
	public static void showWindow() {
		...
		JFrame frame =  new JFrame("Chemex");
...
//-----------------------------------------------------------------------------------------------------------
		...
		JLabel lblNewLabel = new JLabel("Chemex");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setBounds(220, 6, 87, 32);
